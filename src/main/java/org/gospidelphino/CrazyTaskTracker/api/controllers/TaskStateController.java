...
import org.gospidelphino.CrazyTaskTracker.api.factories.TaskStateDtoFactory;
...
import org.gospidelphino.CrazyTaskTracker.store.repository.TaskStateRepository;
...
public class TaskStateController {
    ...
    public TaskStateDto changeTaskStatePosition(
        ...
        if (optionalNewLeftTaskState.isPresent()) {
            ...
            changeTaskState.setRightTaskState(newLeftTaskState);
        } else {
